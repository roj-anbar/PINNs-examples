"""
To solve 1D linear steady advection-diffusion equation with given velocity (v) and diffusion (D).
Domain: x = [0, 1]
PDE: v * du/dx = d2u/dx2
BCs: u(x=0) = 1 / u(x=1) = 0.1
Params: v=1 / D=0.05
...
net2_final = geo_train(device,x,xb,cb,batchsize,learning_rate,epochs,path,Flag_batch,C_analytical,Vel,Diff,Flag_BC_exact )
#tic = time.time()
